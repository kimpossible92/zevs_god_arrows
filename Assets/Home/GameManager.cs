...
public class GameManager : MonoBehaviour {
	...
	public static ArrowPt selectedKnifePrefab=null;
	...
	public static int score
	{
		...
		set
		{
			...
			if(FindObjectOfType<GamePlayManager>() != null)
				FindObjectOfType<GamePlayManager>().UpdateLable ();
		}
	}
	static int _score;
	...
	public static int Apple
	{
		...
		set
		{
			...
			//if (GeneralFunction.intance != null) GeneralFunction.intance.appleLbl.text = GameManager.Apple + "";
		}
	}
